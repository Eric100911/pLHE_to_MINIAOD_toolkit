...
# with command line options: --python_filename SKIM_2023C.py --eventcontent MINIAODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier MINIAODSIM --filein file:JJY_TPS_RECO_2023C_test.root --fileout file:JJY_TPS_MINIAOD_2023C_test.root --conditions 130X_mcRun3_2023_realistic_v14 --step PAT -nThreads 8 --geometry DB:Extended --era Run3 --no_exec --mc -n -1
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:JJY_TPS_RECO_2023C_test.root'),
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:JJY_TPS_MINIAOD_2023C_test.root'),
